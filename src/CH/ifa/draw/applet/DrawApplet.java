...
public class DrawApplet
	...
	private transient MDDrawingView fView;
	...
	public void init() {
		...
		getContentPane().add("Center", (Component)view().getPanel());
	...
	protected MDDrawingView createDrawingView() {
		return MDDrawingViewFactory.newSubjectRoleDrawingView(this, 410, 370);
	}
