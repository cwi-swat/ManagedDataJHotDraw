...
public abstract class DNDHelper implements DropTargetListener,DragSourceListener,DragGestureListener {
	...
	abstract protected MDDrawingView view();
	...
	public void dragGestureRecognized(DragGestureEvent dge) {
		...
		if (MDDrawingView.class.isInstance(c)) {
			boolean found = false;
			MDDrawingView dv = (MDDrawingView)c;
...
/*              Rectangle r = figgy.displayBox();
	...
	public void dragDropEnd(DragSourceDropEvent dsde) {
		MDDrawingView view = (MDDrawingView) dsde.getDragSourceContext().getComponent();
