...
public class SplitPaneDesktop extends JSplitPane implements Desktop {
	...
	protected Component createContents(MDDrawingView dv, int location) {
	...
	protected Component createRightComponent(MDDrawingView dv) {
	...
	protected Component createLeftComponent(MDDrawingView dv) {
