...
// JUnitDoclet end extends_implements
{
  ...
  CH.ifa.draw.util.PaletteIcon paletteicon = null;
  ...
  */
  public CH.ifa.draw.util.PaletteIcon createInstance() throws Exception {
	...
	MediaTracker tracker = new MediaTracker((DrawApplication)getDrawingEditor());
	for (int i = 0; i < 3; i++) {
  ...
  */
  public static void main(String[] args) {
    ...
    junit.textui.TestRunner.run(PaletteIconTest.class);
