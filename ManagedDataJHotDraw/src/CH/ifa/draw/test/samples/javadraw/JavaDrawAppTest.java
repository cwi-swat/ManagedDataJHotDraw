...
// JUnitDoclet end extends_implements
{
  ...
  CH.ifa.draw.samples.javadraw.JavaDrawApp javadrawapp = null;
  ...
  */
  public CH.ifa.draw.samples.javadraw.JavaDrawApp createInstance() throws Exception {
    // JUnitDoclet begin method testcase.createInstance
    return (JavaDrawApp)getDrawingEditor();
  ...
  */
  public static void main(String[] args) {
    ...
    junit.textui.TestRunner.run(JavaDrawAppTest.class);
