...
// JUnitDoclet end extends_implements
{
  ...
  CH.ifa.draw.contrib.JPanelDesktop jpaneldesktop = null;
  ...
  */
  public CH.ifa.draw.contrib.JPanelDesktop createInstance() throws Exception {
    ...
    return new CH.ifa.draw.contrib.JPanelDesktop((DrawApplication)getDrawingEditor());
  ...
  */
  public static void main(String[] args) {
    ...
    junit.textui.TestRunner.run(JPanelDesktopTest.class);
