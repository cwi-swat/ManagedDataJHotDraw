...
// JUnitDoclet end extends_implements
{
  ...
  CH.ifa.draw.contrib.DesktopEventService desktopeventservice = null;
  ...
  */
  public CH.ifa.draw.contrib.DesktopEventService createInstance() throws Exception {
	...
	Desktop desktop = new JPanelDesktop((DrawApplication)getDrawingEditor());
  ...
  */
  public static void main(String[] args) {
    ...
    junit.textui.TestRunner.run(DesktopEventServiceTest.class);
