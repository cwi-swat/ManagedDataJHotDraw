...
public class Geom {
	...
	static public Point south(MDRectangle r) {
		return new Point(r.x() + r.width() /2, r.y() + r.height());
	}

	static public Point center(MDRectangle r) {
		return new Point(r.x() + r.width() /2, r.y() + r.height()/2);
	}

	static public Point west(MDRectangle r) {
		return new Point(r.x(), r.y() + r.height()/ 2);
	}

	static public Point east(MDRectangle r) {
		return new Point(r.x()+r.width(), r.y() + r.height()/ 2);
	}

	static public Point north(MDRectangle r) {
	 ...
	 * @return   the corner
	 */
	public static Point corner(MDRectangle r) {
	 ...
	 * @return   the corner
	 */
	public static Point topLeftCorner(MDRectangle r)
	{
	 ...
	 * @return   the corner
	 */
	public static Point topRightCorner(MDRectangle r)
	{
	 ...
	 * @return   the corner
	 */
	public static Point bottomLeftCorner(MDRectangle r)
	{
	 ...
	 * @return   the corner
	 */
	public static Point bottomRightCorner(MDRectangle r)
	{
		return corner(r);
	}
	 ...
	 */
	static public double pointToAngle(MDRectangle r, Point p) {
	 ...
	 */
	static public Point angleToPoint(MDRectangle r, double angle) {
	 ...
	 */
	static public Point ovalAngleToPoint(MDRectangle r, double angle) {
